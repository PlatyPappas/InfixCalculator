/*******************************************************************************
** File: infixValidator.cpp
** Purpose: Define functions for infixValidator class
...
*******************************************************************************/
bool infixValidator::checkIn(char toCheck, string validChars) {
	bool isIn = false;
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::isValid (char currChar) {
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::invalidCharCheck(string expressionString) {
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::checkParenthesesPairs(string expressionString) {
	bool stringValid = true;
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::checkOpenParentheses(string expressionString) {
	bool stringValid = true;
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::checkCloseParentheses(string expressionString) {
	bool stringValid = true;
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::parenthesesCheck(string expressionString) {
	bool stringValid = true;
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::operatorPreSpaceCheck(vector<unsigned int> spaces, string expressionString) {
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::operatorPostSpaceCheck(vector<unsigned int> spaces, string expressionString) {
	bool spacesValid = true;
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::operatorCheck(string expressionString) {
	bool stringValid = true;
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::validateZeroes(vector<unsigned int> zeroes, string expressionString) {
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::numberPreSpaceCheck(vector<unsigned int> spaces, string expressionString) {
	bool spacesValid = true;
	string precededBy = "+/*-";
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::numberPostSpaceCheck(vector<unsigned int> spaces, string expressionString) {
	bool spacesValid = true;
	string followedBy = "+/*-";
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::numbersCheck(string expressionString) {
	bool stringValid = true;
	vector<unsigned int> preSpaces;
	vector<unsigned int> postSpaces;
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::spacesCheck(string expressionString) {
...
** Return: Boolean representing validity
*******************************************************************************/
bool infixValidator::fullValidation(string expressionString) {
	bool stringValid = false;
